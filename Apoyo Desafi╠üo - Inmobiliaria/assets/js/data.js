...
descripcion: 'Esta casa antigua está ubicado en una exclusiva zona residencial',
...
descripcion: 'Este apartamento acogedor está situado en centro de la cuidad con impresionantes vistas',
...
descripcion: 'Esta casa de 4 habitaciones está ubicado en el corazón de la ciudad, cerca de todo.',
...
descripcion: 'Este hermosa casa ofrece una vista impresionante al mar',
...
//condiciones para permitir fumar o permitir mascotas
function smokeStatus(smoke) {
    if (smoke === true) {
        return '<p class="text-success"><i class="fas fa-smoking"></i> Se permite fumar</p>';
    } else {
        return '<p class="text-danger"><i class="fas fa-smoking-ban"></i> No se permite fumar</p>';
    }
}

const petsStatus = (pets) => {
    if (pets === true) {
